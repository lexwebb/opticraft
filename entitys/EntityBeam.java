...
public class EntityBeam extends Entity {
	...
	protected void updateDataClient() {
		start.x = decodeDouble(dataWatcher.getWatchableObjectInt(8));
		start.y = decodeDouble(dataWatcher.getWatchableObjectInt(9));
		start.z = decodeDouble(dataWatcher.getWatchableObjectInt(10));
		end.x = decodeDouble(dataWatcher.getWatchableObjectInt(11));
		end.y = decodeDouble(dataWatcher.getWatchableObjectInt(12));
		end.z = decodeDouble(dataWatcher.getWatchableObjectInt(13));
	}
	...
	protected void updateDataServer() {
		...
		dataWatcher.updateObject(8, Integer.valueOf(encodeDouble(start.x)));
		dataWatcher.updateObject(9, Integer.valueOf(encodeDouble(start.y)));
		dataWatcher.updateObject(10, Integer.valueOf(encodeDouble(start.z)));
		dataWatcher.updateObject(11, Integer.valueOf(encodeDouble(end.x)));
		dataWatcher.updateObject(12, Integer.valueOf(encodeDouble(end.y)));
		dataWatcher.updateObject(13, Integer.valueOf(encodeDouble(end.z)));
	}
