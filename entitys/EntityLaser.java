...
public abstract class EntityLaser extends Entity {
        ...
        public static final ResourceLocation[] LASER_TEXTURES = new ResourceLocation[]{
                new ResourceLocation(ModInfo.ID.toLowerCase() + ":textures/entities/laser_1.png"), //TODO
                new ResourceLocation(ModInfo.ID.toLowerCase() + ":textures/entities/laser_2.png"), //TODO
                new ResourceLocation(ModInfo.ID.toLowerCase() + ":textures/entities/laser_3.png"), //TODO
                new ResourceLocation(ModInfo.ID.toLowerCase() + ":textures/entities/laser_4.png")}; //TODO
