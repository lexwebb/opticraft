...
public class CableRenderer extends TileEntitySpecialRenderer implements ISimpleBlockRenderingHandler{
   ...
   //Use in 1.6.2  this
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		ResourceLocation textures = (new ResourceLocation(ModInfo.ID.toLowerCase() + ":textures/blocks/cableTile.png")); 
		Minecraft.getMinecraft().renderEngine.bindTexture(textures);
