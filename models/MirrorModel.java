...
public class MirrorModel extends ModelBase {
	...
	public MirrorModel() {
		...
		MirrorBlock.addBox(-0.5F, -0.5F, -0.7F, 1, 1, 1);
		...
		Mirror.addBox(-1.5F, -2.5F, -0.8F, 3, 5, 0);
	...
	public void renderUp(Entity entity, float f, float f1, float f2, float f3,
			float f4, float f5) {
		Up.render(f5);
		UpBlock.render(f5);
	}

	public void renderDown(Entity entity, float f, float f1, float f2,
			float f3, float f4, float f5) {
		Down.render(f5);
		DownBlock.render(f5);
	}

	public void renderLeft(Entity entity, float f, float f1, float f2,
			float f3, float f4, float f5) {
		Left.render(f5);
		LeftBlock.render(f5);
	}

	public void renderRight(Entity entity, float f, float f1, float f2,
			float f3, float f4, float f5) {
		Right.render(f5);
		RightBlock.render(f5);
	}

	public void renderFront(Entity entity, float f, float f1, float f2,
			float f3, float f4, float f5) {
		Front.render(f5);
		FrontBlock.render(f5);
	}

	public void renderBack(Entity entity, float f, float f1, float f2,
			float f3, float f4, float f5) {
		Back.render(f5);
		BackBlock.render(f5);
	}

	public void mirrorRender(Entity entity, float f, float f1, float f2,
			float f3, float f4, float f5) {
