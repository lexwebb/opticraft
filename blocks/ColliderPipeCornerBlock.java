...
public class ColliderPipeCornerBlock extends DirectionalBlock{
    ...
    public ColliderPipeCornerBlock(int id) {
    ...
    public TileEntity createNewTileEntity(World world) {  		
            return new TileEntityColliderPipeCorner();
    }
    ...
    public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int i, float f, float g, float t){
    	if(player.inventory.getStackInSlot(player.inventory.currentItem) != null 
    		...
    		TileEntityColliderPipeCorner ent = (TileEntityColliderPipeCorner) world.getBlockTileEntity(x, y, z);
